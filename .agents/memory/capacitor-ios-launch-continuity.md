...
**Why:** On a physical iPhone, the native launch storyboard was dismissed while WebContent and GPU processes were still starting. The underlying WebView remained black for roughly two seconds even after a fresh install and fixed background colors. Holding the official splash until React painted was confirmed to remove the black interval.
