...
**Why:** The Plus page could independently detect an active entitlement while Settings retained a stale Free value. Users may interpret that contradiction as a failed payment and should not need Restore Purchases during normal startup.
